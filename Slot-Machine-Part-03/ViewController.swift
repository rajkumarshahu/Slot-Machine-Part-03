...
class ViewController: UIViewController {
    ...
    @IBAction func btnSpin(_ sender: UIButton) {
        ...
        totalWin = totalWin + self.winAmount + self.jackpot
...
//        db.collection("scoreBoard").addDocument(data: ["jackpotAmount": jackpot, "balance": balance, "bet": bet, "totalWin": totalWin])
        
//        let newDocument = db.collection("scoreBoard").document()
//        newDocument.setData(["jackpotAmount": jackpot, "balance": balance, "bet": bet, "totalWin": totalWin, "id": newDocument.documentID])
//
...
//        db.collection("slotMachine").document("scoreBoard").setData(["jackpotAmount": jackpot, "balance": balance, "bet": bet, "totalWin": totalWin])
//
//        print("score button totalWin", totalWin)
    }
    ...
    func updateImages () {
        ...
        let seven = [String](repeating: "seven", count: 540) // 5.5%
...
//        let scoreDetailVC = segue.destination as! ScoreDetailViewController
//
//        if let jackpot = jackPotLabel.text {
//            scoreDetailVC.jackpot = jackpot
//        }
//    }
}
